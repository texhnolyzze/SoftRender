...
public interface Vector3f {
    ...
    public static class vec3 implements Vector3f { // just for internal usage
                
        float x, y, z;
        
        vec3() {}
        vec3(float x, float y, float z) {vec3.this.set(x, y, z);}
        ...
        vec3 scale(float s) {
            return vec3.this.set(x * s, y * s, z * s);
        }
